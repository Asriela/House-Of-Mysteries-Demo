...
//Held_Furniture=noone
    ...
    // NO ROOM SELECTED thus show new room menu 
        ...
        //    if Chosen_Tutorial=tu.start Chosen_Tutorial=tu.add_new_room
            ...
            edit_mode_menu_y += gap;    
				            Item_Being_Placed = Button_Pressed(edit_mode_menu_x + 50, edit_mode_menu_y, length, width, 0, "museum", c_old, c_black, Item_Being_Placed, room_type.museum, 0, default_input, 0, shape.square, 0);
            edit_mode_menu_y += gap;    
