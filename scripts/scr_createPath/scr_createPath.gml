...
function scr_createPath(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {

	//scr_createPath(startx, starty, targetx, targety, cell_size, path_curviness_1-8, smooth, obstacle_objects, allow_diagonal)
